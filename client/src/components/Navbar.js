...
const Navbar = () => {
  ...
  return (
    <nav className="bg-background border-b border-border/50 sticky top-0 z-[100] shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="hidden md:flex items-center space-x-2">
            ...
            {isAuthenticated && (
              <div className="relative users-dropdown">
                ...
                {/* Dropdown Menu */}
                {isUsersDropdownOpen && (
                  <div className="absolute top-full left-0 mt-2 w-48 bg-background border border-border/50 rounded-xl shadow-lg z-[110] py-2">
        ...
        {isMenuOpen && (
          <div className="mobile-menu-container fixed inset-0 z-[110] md:hidden">
            {/* Backdrop */}
            <div 
